---
title: "Organizing ENIGH Household Data for 2014"
...
df_hshd <-read_csv(paste0(path.data, "2014_ENIGH_hogares.csv"), col_names = TRUE,
...
Notes: ENIGH 2014_The variables esc_radio, er_aparato er_celular, 
...
df_hshd <- as_tibble(df_hshd) %>%
  select("folioviv", "foliohog", "huespedes", "huesp_come", "num_trab_d", 
         ...
         "anio_tva", "num_tvd", "anio_tvd", "num_dvd", "anio_dvd", "num_video", 
...
write.csv(df_hshd, file = 'outputs/2014_enigh_households.csv', na = "NULL", 
