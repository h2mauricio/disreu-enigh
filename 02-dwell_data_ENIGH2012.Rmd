---
title: "Organizing ENIGH Dwelling Data for 2014"
...
df_dwell <-read_csv(paste0(path.data, "2014_enigh_viviendas.csv"), 
                    col_names = TRUE, 
                    col_types=c("folioviv"="c", "estufa_chi"= 'i', 
                                'mat_techos' ='i', 'num_dueno1' ='i', 
                                'num_dueno2' ='i'), na ='&')
```
...
#change name of variable factor_viv to factor
colnames(df_dwell)[colnames(df_dwell)=="factor_viv"] <-"factor"
...
```{r}
write.csv(df_dwell, file = 'outputs/2014_enigh_dwellings.csv', na = "NULL", 
