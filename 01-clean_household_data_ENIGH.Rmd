---
title: "Organizing ENIGH Household data"
...
df_hshd <-read_csv(paste0(path.data, "2018_enigh_hogares.csv"), col_names = TRUE,
                   col_types=c("folioviv"="c", "foliohog"="c", 'anio_carret'='i', 'anio_otro'='i', 
                               'trab_come' ='i', 'huesp_come'='i', 'anio_auto' = 'i', 'anio_van' = 'i', 'anio_pickup' = 'i', 'anio_moto' = 'i', 'anio_bici' = 'i', 'anio_trici' = 'i', 'anio_canoa' = 'i', 'anio_ester' = 'i', 'anio_grab' = 'i', 'anio_radio' = 'i', 'anio_tva' = 'i', 'anio_tvd' = 'i', 'anio_dvd' = 'i', 'anio_video' = 'i', 'anio_licua' = 'i', 'anio_tosta' = 'i', 'anio_micro' = 'i', 'anio_refri' = 'i', 'anio_estuf' = 'i', 'anio_lavad' = 'i', 'anio_planc' = 'i', 'anio_maqui' = 'i', 'anio_venti' = 'i', 'anio_aspir' = 'i', 'anio_compu' = 'i', 'anio_impre' = 'i', 'anio_juego'='i'), na ='&')

#df_hshd_conc<-read_csv(paste0(path.data, "2018_enigh_concentradohogar.csv"), 
...
write.csv(df_hshd, file = 'outputs/2018_enigh_households.csv', na = "NULL", 
